...
.title {
  ...
  .title .first {
    ...
    .title .first .first_title {
      float: left;
      font-size: 20px;
      font-weight: bold; }
    .title .first .first_link {
      float: right; }
      .title .first .first_link p {
        float: left;
        margin-right: 10px; }
  .title .second {
    margin: 15px 0;
    clear: both; }
    .title .second .second_title {
      border-left: 4px solid #e8313e; }
      .title .second .second_title span {
        display: inline-block;
        padding-left: 10px; }
