...
.cb-notice-bar {
  ...
  .cb-notice-bar-icon {
    ...
    margin-right: -5px;
    background: #fefcec; }
    .cb-notice-bar-icon.cb-icon {
      font-size: 20px; }
  .cb-notice-bar-operation {
    position: absolute;
    top: 8px;
    right: 0;
    width: 25px;
    z-index: 2;
    background: #fefcec; }
    .cb-notice-bar-operation .cb-icon {
      font-size: 20px; }
  .cb-notice-bar-content-wrap {
    position: relative;
    padding: 0 10px;
    text-overflow: ellipsis;
    white-space: nowrap;
    line-height: 36px; }
    .cb-notice-bar-content-wrap .cb-notice-bar-content {
      position: absolute;
      z-index: 1;
      top: 0;
      bottom: 0;
