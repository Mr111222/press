...
.cb-field .cb-field-required-icon {
  font-size: 0.8rem;
  margin-left: 2px;
  margin-bottom: 2px;
  color: #f56c6c; }
...
.cb-mobile-select {
  ...
  .cb-mobile-select > div {
    ...
    left: 0;
    visibility: visible; }
  .cb-mobile-select .cbm-select-header {
    height: 44px;
    line-height: 44px;
    background-color: #eee;
    width: 100%;
    text-align: center; }
    .cb-mobile-select .cbm-select-header a {
      font-size: 16px;
      color: #e94643;
      text-decoration: none; }
      .cb-mobile-select .cbm-select-header a.close {
        float: left;
        padding-left: 15px;
        height: 44px;
        line-height: 44px; }
      .cb-mobile-select .cbm-select-header a.sure {
        float: right;
        padding-right: 15px;
        height: 44px;
        line-height: 44px; }
  .cb-mobile-select .contain {
    height: 100%;
    overflow: hidden;
    position: absolute;
    height: 245px; }
  .cb-mobile-select .row-title {
    width: 100%;
    height: 35px;
    line-height: 35px;
    ...
    .cb-mobile-select .row-title li {
      float: left;
      text-align: center;
      font-size: 16px; }
  .cb-mobile-select .cbm-select-box {
    overflow: hidden;
    width: 100%;
    height: 100%;
    position: relative; }
    .cb-mobile-select .cbm-select-box ul li {
      font-size: 13px;
      height: 35px;
      line-height: 35px;
      background-color: #f9fafc;
      ...
      color: #111;
      opacity: .3; }
      .cb-mobile-select .cbm-select-box ul li.at {
        font-size: 16px;
        opacity: 1; }
      .cb-mobile-select .cbm-select-box ul li.side1 {
        font-size: 15px;
        opacity: .7; }
      .cb-mobile-select .cbm-select-box ul li.side2 {
        font-size: 14px;
        opacity: .5; }
  .cb-mobile-select .cover-area1, .cb-mobile-select .cover-area2 {
    width: 100%;
    border: none;
    ...
    margin: 0;
    height: 0; }
  .cb-mobile-select .cover-area1 {
    top: 149px; }
  .cb-mobile-select .cover-area2 {
    top: 183px; }
  .cb-mobile-select .title {
    margin: 0;
    padding: 0;
    display: inline-block;
    font-size: 16px;
  ...
  .cb-mobile-select .loading-box {
    ...
    .cb-mobile-select .loading-box .loading {
      width: 50px;
      height: 50px;
      position: absolute;
      left: 50%;
